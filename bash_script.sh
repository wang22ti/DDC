...
python cifar_train.py -a resnet32 --dataset cifar100 --imb_type exp --imb_factor 0.01 --loss_type CVS --train_rule ADRW --seed 0 --wd 0.0002 --epochs 200 --randaug 0 --tro 0.15 --gamma 0.15 --tau 0.9 --max_scale 0.2 --warmup_epochs 10 --min_scale 0.05
