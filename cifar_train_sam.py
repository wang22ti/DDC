...
parser.add_argument('--root_model', type=str, default='log')
...
def main():
    ...
    store_name_list = ['seed', str(args.seed), 'wd', '%.6f' % args.weight_decay, 'sam', str(args.rho), 'args', str((args.tro, args.gamma, args.tau))]
...
def main_worker(args):
    ...
    optimizer = SAM(base_optimizer=torch.optim.SGD, params=model.parameters(), lr=args.lr, momentum=args.momentum, weight_decay=args.weight_decay)
